...
//=================================================================
//
// Version 1.0.7.37    08/26/2018 Original Yan Cheng, JStock Gui MarketJPanel Class.
...
public class MarketJPanel extends javax.swing.JPanel {
    ...
    private void initAccordingToCountry(Country country) {
        ...
        for (final Index index : indices)
        {
            ...
            indexPanel.setBorder(BorderFactory.createEtchedBorder());
            ...
            value.setBorder(BorderFactory.createCompoundBorder(BorderFactory.createLoweredBevelBorder(),
                                                               BorderFactory.createEmptyBorder(2, 5, 2, 5)));
            value.setFont(Utils.getBoldFont(value.getFont()));
            indexPanel.add(value);
            
            leftPanel.add(indexPanel);
