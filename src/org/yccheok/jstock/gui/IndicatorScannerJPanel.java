 ...
 * 
 * Version 1.0.7.37.02 03/10/2019
 *
...
//=================================================================
//
// Version 1.0.7.37    08/26/2018 Original Yan Cheng, JStock Gui IndicatorScannerJPanel Class.
//         1.0.7.37.01 02/24/2019 Method update() Commented m.displayPopupMessage().
//         1.0.7.37.02 03/08/2019 Method getMyJTablePopupMenu() menuItem.addActionListener()
//                                Changed m, JStock, addSTockToTable() to m.watchListPanel.
//                                addStockToTable(). Commented Unused TradingView? Slated
//                                for Removal.
//         1.0.7.37.03 03/10/2019 Commented Class Instances email/systemTrayAlertPool. Commented
//                                All Aspects of Implementing These Features, Imports, Methods
//                                Processing. Commented saveAsExcelFile().
//
//-----------------------------------------------------------------
//                 yccheok@yahoo.com
 ...
 * @version 1.0.7.37.03 03/10/2019
 */
public class IndicatorScannerJPanel extends javax.swing.JPanel implements ChangeListener, org.yccheok.jstock.engine.Observer<Indicator, Boolean> {
    ...
    private void initAlertDataStructures() {
        ...
        //inal ExecutorService oldSystemTrayAlertPool = systemTrayAlertPool;
            ...
            public void actionPerformed(ActionEvent evt) {
                ...
                for (int row : rows) {
                    ...
                    if (indicator != null) {
                        ...
                        m.watchListPanel.addStockToTable(indicator.getStock());
                    }
                }
            }
        });
